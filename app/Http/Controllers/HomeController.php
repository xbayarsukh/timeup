...
class HomeController extends Controller
{
    public function index(){
        ...
        $timecheck = DB::table('time_check')->get();
        $today = DB::table('time_check')->whereDate('created_at', \Carbon\Carbon::today())->get();
        $ago1 = DB::table('time_check')->whereDate('created_at', \Carbon\Carbon::today()->subDays(1))->get();
        $ago2 = DB::table('time_check')->whereDate('created_at', \Carbon\Carbon::today()->subDays(2))->get();
        $ago3 = DB::table('time_check')->whereDate('created_at', \Carbon\Carbon::today()->subDays(3))->get();
        $ago4 = DB::table('time_check')->whereDate('created_at', \Carbon\Carbon::today()->subDays(4))->get();
        $ago5 = DB::table('time_check')->whereDate('created_at', \Carbon\Carbon::today()->subDays(5))->get();
        $ago6 = DB::table('time_check')->whereDate('created_at', \Carbon\Carbon::today()->subDays(6))->get();
        $ago7 = DB::table('time_check')->whereDate('created_at', \Carbon\Carbon::today()->subDays(7))->get();
        $ago8 = DB::table('time_check')->whereDate('created_at', \Carbon\Carbon::today()->subDays(8))->get();
        $ago9 = DB::table('time_check')->whereDate('created_at', \Carbon\Carbon::today()->subDays(9))->get();
        $ago10 = DB::table('time_check')->whereDate('created_at', \Carbon\Carbon::today()->subDays(10))->get();
        $ago11 = DB::table('time_check')->whereDate('created_at', \Carbon\Carbon::today()->subDays(11))->get();
        $ago12 = DB::table('time_check')->whereDate('created_at', \Carbon\Carbon::today()->subDays(12))->get();
        $ago13 = DB::table('time_check')->whereDate('created_at', \Carbon\Carbon::today()->subDays(13))->get();
