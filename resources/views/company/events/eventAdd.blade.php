    ...
    <div class="col-12">
      <div class="card mb-4">
        ...
        <div class="card z-index-0">
          ...
          <div class="card-body">
            {!! Form::open(['url' => 'admin/events/add', 'method'=>'post', 'role'=>'form', 'files' => true, 'enctype'=>'multipart/form-data' ]) !!}
            
              <div class="mb-3">
                <select class="form-control" name="category" id="" required>
                  <option value="">Төрөлөө сонгоно уу</option>
              ...
              <div class="mb-3">
                <input type="text" name="where" class="form-control" placeholder="Хаана" required>
              </div>
              ...
              <div class="mb-3" >
                <div class="col-5 mb-3" style="float:left">
                  <input type="date" name="when" class="form-control" placeholder="Хэзээ" required>
                </div>
                <div class="col-5 mb-3" style="float:right">
                  <input type="time" name="many_time" class="form-control" placeholder="Хэдээс" required>
                </div>
              </div>
              <br></br>
...
<script type="text/javascript"> 
  ...
  function initMap() {
    var mapOptions = {
      center: new google.maps.LatLng(47.9188, 106.9176),
      zoom: 13,
    ...
    var myMarker = new google.maps.Marker({
        position: new google.maps.LatLng(47.9188, 106.9176),
        draggable: true,
        map: map
    });
    google.maps.event.addListener(myMarker, 'dragend', function(evt){
      $('#lat').val(evt.latLng.lat().toFixed(4));
      $('#long').val(evt.latLng.lng().toFixed(4));
    });
  }
</script>
@endsection